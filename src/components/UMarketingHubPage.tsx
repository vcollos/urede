...
const EMBEDDED_SUBAPP_URL = '/sub_apps/central_arquivos/index.html?module=umarketing';

export function UMarketingHubPage() {
  return (
    <div>
      <section className="rounded-3xl border border-[#E7E4FB] bg-white shadow-sm">
        <div className="flex items-center justify-between gap-3 border-b border-[#E7E4FB] px-4 py-3">
          <div className="flex items-center gap-2 text-sm font-medium text-gray-700">
            <Megaphone className="h-4 w-4 text-[#5A46C5]" />
            Modo integrado no Hub
          </div>
          <span className="rounded-full bg-[#EEF5FF] px-3 py-1 text-xs font-medium text-[#2956C4]">/umarketing/dashboard</span>
        </div>
...
export const CentralMarketingHubPage = UMarketingHubPage;
